...
# input
hostler_numbers = 5
loading_time = 0.1  # unit: hr

file_path = f'{hostler_numbers}_hostler_density.xlsx'
xls = pd.ExcelFile(file_path)

density_data = xls.parse(sheet_name=0)  # density: sheet 1
hostler_data = xls.parse(sheet_name=1)  # hostler: sheet 2
truck_data = xls.parse(sheet_name=2)    # truck:   sheet 3
...
hostler_data['HostlerActualTravelTime'] = hostler_data['HostlerTravelTime'] - loading_time
...
truck_data['TruckActualTravelTime'] = truck_data['TruckTravelTime'] - loading_time
